          ...
          case 'onMyFunc':
            {
              ...
              _jsContextResponse =
                  await _executeJavascriptEngine(_jsContext, 'onMyFunc');
              ...
              controller.future.then((webviewController) {
                webviewController.evaluateJavascript(
                    'document._observer.notify("$_jsContextResponse")');
              });
            }
            break;
          ...
          case 'onMyFunc2':
            {
              ...
              String _jsContextResponse = '<empty>';
              _jsContextResponse =
                  await _executeJavascriptEngine(_jsContext, 'onMyFunc2');
              // Logic layer needs to run this registered js callback in miniapp/index.js
              print('Response from isolated js code was: $_jsContextResponse');
              // Return this to the renderer to call re-render
...
Future<String> _executeJavascriptEngine(
  ...
  try {
    ...
    String _pageCode = await rootBundle
        .loadString('/data/user/0/com.example.superapp/app_flutter/index.js');
